...
class _MyHomePageState extends ConsumerState<MyHomePage> {
  ...
  // late DateFormat _dateFormat = DateFormat('yyyy年MMMd日', 'en-US');
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            title: Row(
              ...
              children: [
                Text(
                  Languages.of(context)!.mainAppbarCaption,
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 20,
          ...
          children: [
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Center(
                      child: Text(
                        Languages.of(context)!.plzEnterPatientInfo ,
                        style: TextStyle(
                          fontSize: 18,
                          color: Colors.black,
                          // fontWeight: FontWeight.bold,
              ...
              child:Padding(
                ...
                Expanded(
                  ...
                  alignment: Alignment.topLeft,
                    child:Text(Languages.of(context)!.age +":",
                        style: TextStyle(
                          fontSize: 16,
                          color: label_color,
                          // fontWeight: FontWeight.bold,
                  ...
                  children: [
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          labelText: Languages.of(context)!.year,
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        keyboardType: TextInputType.number,
                        decoration: InputDecoration(
                          labelText: Languages.of(context)!.month,
                          border: OutlineInputBorder(),
                        ),
                      ),
                    ),
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        keyboardType: TextInputType.number,
                        decoration: InputDecoration(
                          labelText: Languages.of(context)!.day,
                          border: OutlineInputBorder(),
                        ),
                      ),
                    ),
                  ...
                  Expanded(
                    child: Column(
                      children: [
                        Row(
                          children: [
                            Text(Languages.of(context)!.weight+':',style: TextStyle(
                              fontSize: 16,
                              color: label_color,
                              // fontWeight: FontWeight.bold,
                            )),
                            ...
                            Expanded(
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  hintText: Languages.of(context)!.data,
                                ),
                                onChanged: (text) {
                        ...
                        Row(
                          children: [
                            Text(Languages.of(context)!.tall+':',style: TextStyle(
                              fontSize: 16,
                              color: label_color,
                              // fontWeight: FontWeight.bold,
                            )),
                        ...
                        Row(
                          children: [
                            Text(Languages.of(context)!.bmi+':',style: TextStyle(
                              fontSize: 16,
                              color: label_color,
                              // fontWeight: FontWeight.bold,
                            )),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(child:Text(Languages.of(context)!.sizeEstimationBySegmentos,
                              style: TextStyle(
                                fontSize: 15,
                ...
                Container(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child:
                      Text(Languages.of(context)!.enterData,
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 18,
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          // child: Center(
                          child: Text(
                            Languages.of(context)!.shoulder_elbow+':',
                            style: TextStyle(
                              fontSize: 16,
                              color: label_color,
                              // fontWeight: FontWeight.bold,
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          // child: Center(
                          child: Text(
                            Languages.of(context)!.knee_heel+':',
                            style: TextStyle(
                              fontSize: 16,
                              color: label_color,
                              // fontWeight: FontWeight.bold,
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          // child: Center(
                          child: Text(
                            Languages.of(context)!.tibia_malleolus+':',
                            style: TextStyle(
                              fontSize: 16,
                              color: label_color,
                              // fontWeight: FontWeight.bold,
                    ...
                    Padding(
                      ...
                      child:
                      Text(Languages.of(context)!.select_segments,
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 18,
                    ...
                    Text(Languages.of(context)!.tall+' '+tall.text+' cm',
                      style: TextStyle(
                      fontSize: 24,
              ...
              child: Row(
                children: [
                  Expanded(
                    // child: Center(
                    child: Text(
                      Languages.of(context)!.headLength+':',
                      style: TextStyle(
                        fontSize: 16,
                        color: label_color,
                        // fontWeight: FontWeight.bold,
            ...
            Padding(
              ...
              child:Align(
                ...
                child:
                  Text(Languages.of(context)!.calculate
                    ,style: TextStyle(
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton(
                        child: Text(Languages.of(context)!.who +' 2006,\n2007',
                          style: TextStyle(
                              color: Colors.white
                          ),
                          textAlign: TextAlign.center,
                          ...
                          if (double.tryParse(imc.text)==null||double.tryParse(weight.text)==null||double.tryParse(tall.text)==null) {
                            ...
                            showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  title: Text(Languages.of(context)!.Data),
                                  content: Text(Languages.of(context)!.inputWarning),
                                  actions: [
                                    ElevatedButton(
                                      child: Text("OK"),
                                      onPressed: () {
